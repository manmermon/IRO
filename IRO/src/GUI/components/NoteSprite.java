...
{ 	
	...
	public void setInstrument( String instr )
	{
		...
		this.chord.setInstrument( instrument );		
	}
	
	public IROChord getNotes()
	{
		return this.chord;
	}
	...
	{	
		...
		if( !this.isGhost )
		{
			pic = (BufferedImage)AppIcons.getInstrument( this.chord.getInstrument(), this.noteScreenSize, this.color );			
		}
