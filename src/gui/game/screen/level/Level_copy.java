...
public class Level_copy extends Scene implements IPausable, IStoppable
{
	...
	public Level_copy( Rectangle sceneSize, List< Settings > playerSettings, List< File > midiMusicSheelFiles ) throws Exception 
	{
	...
	{			
		...
		{	
			...
			protected void runInLoop() throws Exception 
			{
				...
				if( delayFromFret < 0 )
				{
					delayFromFret = getDelayFromFret();
				}
				...
				{	
					...
					int playerIndex = -1;
					int numPlayers = Level_copy.this.playerSettings.size();
					int modPlayers = 1;
					...
					for( Settings cfg : Level_copy.this.playerSettings )
					{							
						playerIndex++;
