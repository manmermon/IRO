...
import lslInput.exception.LostException;
import lslInput.exception.TimeoutException;
...
public class LSL 
{
    ...
    */
   public static LSLStreamInfo[] resolve_streams(double wait_time)
   {
   ...
   public static LSLStreamInfo[] resolve_streams() { return resolve_streams(1.0); }
   ...
   public static LSLStreamInfo[] resolve_stream(String prop, String value, int minimum) { return resolve_stream(prop, value, minimum, LSLStreamInfo.TIME_FOREVER); }
   public static LSLStreamInfo[] resolve_stream(String prop, String value) { return resolve_stream(prop, value, 1, LSLStreamInfo.TIME_FOREVER); }
   ...
   public static LSLStreamInfo[] resolve_stream(String pred, int minimum) { return resolve_stream(pred, minimum, LSLStreamInfo.TIME_FOREVER); }
   public static LSLStreamInfo[] resolve_stream(String pred) { return resolve_stream(pred, 1, LSLStreamInfo.TIME_FOREVER); }
   ...
   public static class StreamInlet
   {
        ...
        */
       public LSLStreamInfo info( double timeout ) throws Exception 
       { 
       ...
       public LSLStreamInfo info() throws Exception 
       { 
       	return info( LSLStreamInfo.TIME_FOREVER ); 
       }
       ...
       public void open_stream() throws Exception { open_stream( LSLStreamInfo.TIME_FOREVER ); }
       ...
       public double time_correction() throws Exception { return time_correction( LSLStreamInfo.TIME_FOREVER  ); }
       ...
       public double pull_sample(float[] sample) throws Exception { return pull_sample(sample, LSLStreamInfo.TIME_FOREVER );  }
       ...
       public double pull_sample(double[] sample) throws Exception { return pull_sample(sample, LSLStreamInfo.TIME_FOREVER ); }
       ...
       public double pull_sample(long[] sample) throws Exception { return pull_sample(sample, LSLStreamInfo.TIME_FOREVER ); }
       ...
       public double pull_sample(int[] sample) throws Exception { return pull_sample(sample, LSLStreamInfo.TIME_FOREVER ); }
       ...
       public double pull_sample(short[] sample) throws Exception { return pull_sample(sample, LSLStreamInfo.TIME_FOREVER ); }
       ...
       public double pull_sample(byte[] sample) throws Exception { return pull_sample(sample, LSLStreamInfo.TIME_FOREVER ); }
       ...
       public double pull_sample(String[] sample) throws Exception { return pull_sample(sample, LSLStreamInfo.TIME_FOREVER ); }        
