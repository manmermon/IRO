...
{	
	...
	private static MusicPlayerControl_copy mpctr = null;
	...
	private MusicPlayerControl_copy( )
	{	
	...
	public static MusicPlayerControl_copy getInstance()
	{
		if( mpctr == null )
		{
			mpctr = new MusicPlayerControl_copy();
		}
